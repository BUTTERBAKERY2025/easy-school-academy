...
export const strings = {
  brand: {
    name: { ar: "أكاديمية سكول أون", en: "School On Academy" },
    short: { ar: "سكول أون", en: "School On" },
    tagline: {
  ...
  home: {
    eyebrow: { ar: "من الروضة حتى الصف الثالث المتوسط", en: "From kindergarten to Grade 9" },
    heroTitle: {
      ar: "منهج مدرستك كامل، بشرح تفاعلي خطوة بخطوة",
      en: "Your child's full school curriculum, taught interactively step by step",
    },
    heroBody: {
      ar: "دروس مبنية على الكتاب المدرسي نفسه — أمريكي، بريطاني، أو سعودي — مع شرح مصوّر وأنشطة وتمارين فورية التصحيح وتقارير متابعة لولي الأمر.",
      en: "Lessons built on the same textbook your child studies — American, British or Saudi — with illustrated explanations, activities, instantly graded practice and parent progress reports.",
    },
    ctaPrimary: { ar: "جرّب درسًا الآن مجانًا", en: "Try a lesson free" },
    ctaSecondary: { ar: "استعرض المناهج", en: "Browse curricula" },
    ...
    curriculaTitle: { ar: "اختر منهج طفلك", en: "Choose your child's curriculum" },
    curriculaBody: {
      ar: "كل منهج مبني بنطاقه وتسلسله الرسمي، بمسمّيات الصفوف والمواد كما هي في المدرسة.",
      en: "Each curriculum follows its official scope and sequence, with the same grade and subject names used at school.",
    },
    featuresTitle: { ar: "لماذا سكول أون؟", en: "Why School On?" },
    howTitle: { ar: "كيف يتعلّم الطالب عندنا؟", en: "How a student learns here" },
  ...
  dashboard: {
    greeting: { ar: "أهلًا", en: "Welcome back" },
  ...
  auth: {
    ...
    demoHint: {
      ar: "حساب تجريبي: student@school-on.test / كلمة المرور: demo1234",
      en: "Demo account: student@school-on.test / password: demo1234",
    },
