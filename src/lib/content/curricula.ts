  ...
  stages: [
    {
      ...
      grades: [{ ordinal: 0, title: "Kindergarten|الروضة", shortTitle: "KG|روضة", ages: "5-6", band: "early" }],
    },
    {
      id: "elementary",
      ...
      grades: [
        { ordinal: 1, title: "Grade 1|الصف الأول", shortTitle: "G1|أول", ages: "6-7", band: "lower" },
        { ordinal: 2, title: "Grade 2|الصف الثاني", shortTitle: "G2|ثاني", ages: "7-8", band: "lower" },
        { ordinal: 3, title: "Grade 3|الصف الثالث", shortTitle: "G3|ثالث", ages: "8-9", band: "middle" },
        { ordinal: 4, title: "Grade 4|الصف الرابع", shortTitle: "G4|رابع", ages: "9-10", band: "middle" },
        { ordinal: 5, title: "Grade 5|الصف الخامس", shortTitle: "G5|خامس", ages: "10-11", band: "middle" },
      ],
    },
    {
      id: "middle",
      ...
      grades: [
        { ordinal: 6, title: "Grade 6|الصف السادس", shortTitle: "G6|سادس", ages: "11-12", band: "upper" },
        { ordinal: 7, title: "Grade 7|الصف السابع", shortTitle: "G7|سابع", ages: "12-13", band: "upper" },
        { ordinal: 8, title: "Grade 8|الصف الثامن", shortTitle: "G8|ثامن", ages: "13-14", band: "upper" },
      ],
    },
  ],
  subjects: [
    ...
    {
      key: "ela",
      title: "English Language Arts|اللغة الإنجليزية وفنونها",
...
const britishCurriculum: CurriculumDef = {
  ...
  stages: [
    {
      id: "eyfs",
      title: "Early Years Foundation Stage|مرحلة التأسيس المبكر",
      ...
      grades: [{ ordinal: 0, title: "Reception|الروضة", shortTitle: "R|روضة", ages: "4-5", band: "early" }],
    },
    {
      id: "ks1",
      title: "Key Stage 1|المرحلة الرئيسة الأولى",
      ...
      grades: [
        { ordinal: 1, title: "Year 1|السنة الأولى", shortTitle: "Y1|الأولى", ages: "5-6", band: "lower" },
        { ordinal: 2, title: "Year 2|السنة الثانية", shortTitle: "Y2|الثانية", ages: "6-7", band: "lower" },
      ],
    },
    {
      id: "ks2",
      title: "Key Stage 2|المرحلة الرئيسة الثانية",
      description: "Years 3 to 6, the heart of primary school.|من السنة الثالثة إلى السادسة، قلب المرحلة الابتدائية.",
      grades: [
        { ordinal: 3, title: "Year 3|السنة الثالثة", shortTitle: "Y3|الثالثة", ages: "7-8", band: "middle" },
        { ordinal: 4, title: "Year 4|السنة الرابعة", shortTitle: "Y4|الرابعة", ages: "8-9", band: "middle" },
        { ordinal: 5, title: "Year 5|السنة الخامسة", shortTitle: "Y5|الخامسة", ages: "9-10", band: "middle" },
        { ordinal: 6, title: "Year 6|السنة السادسة", shortTitle: "Y6|السادسة", ages: "10-11", band: "middle" },
      ],
    },
    {
      id: "ks3",
      title: "Key Stage 3|المرحلة الرئيسة الثالثة",
      ...
      grades: [
        { ordinal: 7, title: "Year 7|السنة السابعة", shortTitle: "Y7|السابعة", ages: "11-12", band: "upper" },
        { ordinal: 8, title: "Year 8|السنة الثامنة", shortTitle: "Y8|الثامنة", ages: "12-13", band: "upper" },
        { ordinal: 9, title: "Year 9|السنة التاسعة", shortTitle: "Y9|التاسعة", ages: "13-14", band: "upper" },
      ],
    },
  ],
  subjects: [
...
const saudiCurriculum: CurriculumDef = {
  ...
  subjects: [
    ...
    },
    {
      ...
      description: "جغرافية المملكة وتاريخها ونظامها ورؤيتها ٢٠٣٠.|The Kingdom's geography, history, governance and Vision 2030.",
      glyph: "🗺️",
      theme: "sun",
      bank: socialSaBank,
      fromOrdinal: 4,
