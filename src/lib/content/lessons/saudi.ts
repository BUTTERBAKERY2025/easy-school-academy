    ...
    blocks: [
      {
        ...
        body: {
          ar: "الكسران ٢/٧ و٣/٧ متشابهان لأن المقام في كليهما ٧، أي أن الكل قُسّم إلى سبع قطع متساوية. وما دامت القطع بالحجم نفسه فجمعها سهل: نعدّ القطع فقط.",
        ...
        visual: { type: "fraction", numerator: 5, denominator: 7, caption: { ar: "٢/٧ + ٣/٧ = ٥/٧", en: "2/7 + 3/7 = 5/7" } },
      },
      {
        kind: "callout",
        id: "t1",
      ...
      },
      {
        kind: "example",
        id: "e1",
        title: { ar: "مثال محلول: ٥/٩ − ٢/٩", en: "Worked example: 5/9 − 2/9" },
        steps: [
          { ar: "المقامان متساويان: ٩ و٩.", en: "The denominators match: 9 and 9." },
          { ar: "نطرح البسطين: ٥ − ٢ = ٣.", en: "Subtract the numerators: 5 − 2 = 3." },
          { ar: "نبقي المقام: ٩.", en: "Keep the denominator: 9." },
          { ar: "الناتج ٣/٩، ويمكن تبسيطه إلى ١/٣.", en: "The answer is 3/9, which simplifies to 1/3." },
        ],
      },
      {
        kind: "mcq",
        id: "q1",
        prompt: { ar: "ما ناتج ٤/١١ + ٥/١١؟", en: "What is 4/11 + 5/11?" },
        choices: [
          { id: "a", label: { ar: "٩/٢٢", en: "9/22" } },
          { id: "b", label: { ar: "٩/١١", en: "9/11" } },
          { id: "c", label: { ar: "٢٠/١١", en: "20/11" } },
        ],
        correctId: "b",
        hint: { ar: "المقام يبقى كما هو.", en: "The denominator stays the same." },
        explanation: { ar: "٤ + ٥ = ٩ والمقام ١١، فالناتج ٩/١١.", en: "4 + 5 = 9 with denominator 11, so the answer is 9/11." },
      },
      {
        kind: "fill",
        id: "q2",
        prompt: { ar: "أكمل الفراغين.", en: "Fill in both blanks." },
        text: { ar: "٧/١٢ − ٣/١٢ = {{1}}/{{2}}", en: "7/12 − 3/12 = {{1}}/{{2}}" },
        blanks: [
          { id: "b1", answers: ["4", "٤"] },
          { id: "b2", answers: ["12", "١٢"] },
        ],
        explanation: { ar: "٧ − ٣ = ٤، والمقام يبقى ١٢، فالناتج ٤/١٢ = ١/٣.", en: "7 − 3 = 4 and the denominator stays 12, giving 4/12 = 1/3." },
      },
      {
        kind: "mcq",
        id: "q3",
        prompt: {
          ar: "قرأ خالد ٣/١٠ من الكتاب يوم السبت، و٤/١٠ يوم الأحد. كم قرأ من الكتاب؟",
          en: "Khalid read 3/10 of a book on Saturday and 4/10 on Sunday. How much of the book has he read?",
        },
        choices: [
          { id: "a", label: { ar: "٧/١٠", en: "7/10" } },
          { id: "b", label: { ar: "٧/٢٠", en: "7/20" } },
          { id: "c", label: { ar: "١/١٠", en: "1/10" } },
        ],
        correctId: "a",
        explanation: {
          ar: "الكتاب نفسه مقسّم إلى ١٠ أجزاء: ٣ + ٤ = ٧، فقرأ ٧/١٠ وبقي له ٣/١٠.",
      ...
      },
      {
        kind: "truefalse",
        id: "q4",
        statement: { ar: "عند جمع ٢/٦ + ٣/٦ نجمع المقامين فيصبح ٥/١٢.", en: "When adding 2/6 + 3/6 we add the denominators to get 5/12." },
        answer: false,
        explanation: {
          ar: "خطأ شائع. المقام يبقى ٦ لأن حجم القطعة لم يتغيّر، فالناتج ٥/٦.",
  ...
  "saudi-g4-arabic-qiraa-1": {
    ...
    blocks: [
      ...
      },
      {
        ...
        body: {
          ar: "١) في صباح مشمس، خرج سعد إلى المزرعة فوجد عشًّا صغيرًا سقط من الشجرة، فحمله بحذر وأعاده إلى مكانه.\n\n٢) أرى أن قراءة عشر دقائق يوميًا تغيّر حياة الطالب؛ فالدليل أن من يقرأ يوميًا تزداد حصيلته اللغوية ويتحسّن تعبيره.\n\n٣) أعلنت أمانة منطقة الرياض أمس افتتاح حديقة جديدة في حي النرجس تضم مسارات للمشي وملاعب للأطفال.",
      ...
      },
      {
        ...
        pairs: [
          { id: "p1", left: { ar: "المقطع ١: سعد والعش", en: "Passage 1: Saad and the nest" }, right: { ar: "نص قصصي", en: "Narrative" } },
          { id: "p2", left: { ar: "المقطع ٢: القراءة اليومية", en: "Passage 2: Reading daily" }, right: { ar: "نص مقالي", en: "Article" } },
          { id: "p3", left: { ar: "المقطع ٣: افتتاح الحديقة", en: "Passage 3: The park opening" }, right: { ar: "نص خبري", en: "News report" } },
        ],
        explanation: {
    ...
    blocks: [
      {
        ...
        body: {
          ar: "في الخامس من شوال ١٣١٩هـ (يناير ١٩٠٢م) استعاد الملك عبدالعزيز بن عبدالرحمن آل سعود مدينة الرياض ومعه رجال قليلون. ومن الرياض بدأت رحلة امتدت نحو ثلاثين عامًا ضمّت خلالها مناطق نجد والأحساء وعسير والحجاز، حتى صدر المرسوم الملكي بتسمية البلاد «المملكة العربية السعودية» في ٢١ جمادى الأولى ١٣٥١هـ الموافق ٢٣ سبتمبر ١٩٣٢م.",
        ...
        visual: {
          ...
          rows: [
            [{ ar: "استعادة الرياض", en: "Recapture of Riyadh" }, { ar: "١٣١٩هـ", en: "1319 AH" }, { ar: "١٩٠٢م", en: "1902" }],
            [{ ar: "ضم الأحساء", en: "Al-Ahsa joins" }, { ar: "١٣٣١هـ", en: "1331 AH" }, { ar: "١٩١٣م", en: "1913" }],
            [{ ar: "ضم الحجاز", en: "The Hijaz joins" }, { ar: "١٣٤٣هـ", en: "1343 AH" }, { ar: "١٩٢٥م", en: "1925" }],
            [{ ar: "إعلان المملكة العربية السعودية", en: "The Kingdom is proclaimed" }, { ar: "١٣٥١هـ", en: "1351 AH" }, { ar: "١٩٣٢م", en: "1932" }],
          ],
        },
      },
      {
      ...
      },
      {
        ...
        items: [
          { id: "o1", label: { ar: "استعادة الرياض ١٣١٩هـ", en: "Recapture of Riyadh, 1319 AH" } },
          { id: "o2", label: { ar: "ضم الأحساء ١٣٣١هـ", en: "Al-Ahsa joins, 1331 AH" } },
          { id: "o3", label: { ar: "ضم الحجاز ١٣٤٣هـ", en: "The Hijaz joins, 1343 AH" } },
          { id: "o4", label: { ar: "إعلان المملكة العربية السعودية ١٣٥١هـ", en: "The Kingdom is proclaimed, 1351 AH" } },
        ],
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: { ar: "١٩٠٢م", en: "1902" } },
          { id: "b", label: { ar: "١٩٢٥م", en: "1925" } },
          { id: "c", label: { ar: "١٩٣٢م", en: "1932" } },
        ],
        correctId: "c",
        hint: { ar: "اليوم الوطني يوافق ٢٣ سبتمبر من ذلك العام.", en: "The National Day falls on 23 September of that year." },
        explanation: { ar: "صدر المرسوم في ١٣٥١هـ الموافق ١٩٣٢م، ويُحتفل به في اليوم الوطني.", en: "The decree was issued in 1351 AH / 1932, celebrated each year as National Day." },
      },
      {
        kind: "multi",
        id: "q3",
      ...
      },
      {
        ...
        title: { ar: "خلاصة الدرس", en: "Lesson summary" },
        points: [
          { ar: "بدأ التوحيد باستعادة الرياض ١٣١٩هـ / ١٩٠٢م.", en: "Unification began with the recapture of Riyadh in 1319 AH / 1902." },
          { ar: "أُعلنت المملكة العربية السعودية ١٣٥١هـ / ١٩٣٢م.", en: "The Kingdom of Saudi Arabia was proclaimed in 1351 AH / 1932." },
