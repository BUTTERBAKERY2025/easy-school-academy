    ...
    blocks: [
      {
        ...
        body: {
          ar: "١/٢ و٢/٤ و٤/٨ كلها تعني النصف نفسه. الفرق أن الكل قُسّم إلى قطع أصغر وأكثر، لكن المقدار المأخوذ بقي كما هو.",
        ...
        visual: { type: "fraction", numerator: 4, denominator: 8, caption: { ar: "٤/٨ تساوي ١/٢ تمامًا", en: "4/8 is exactly the same as 1/2" } },
      },
      {
        kind: "callout",
        id: "t1",
      ...
      },
      {
        kind: "example",
        id: "e1",
        title: { ar: "مثال محلول: أوجد كسرًا مكافئًا لـ ٢/٣", en: "Worked example: find a fraction equivalent to 2/3" },
        steps: [
          { ar: "نختار عددًا، ليكن ٤.", en: "Choose a number, say 4." },
          { ar: "نضرب البسط: ٢ × ٤ = ٨.", en: "Multiply the numerator: 2 × 4 = 8." },
          { ar: "نضرب المقام في العدد نفسه: ٣ × ٤ = ١٢.", en: "Multiply the denominator by the same number: 3 × 4 = 12." },
          { ar: "إذن ٢/٣ = ٨/١٢.", en: "So 2/3 = 8/12." },
        ],
      },
      {
        kind: "mcq",
        id: "q1",
        prompt: { ar: "أي الكسور التالية يكافئ ٣/٤؟", en: "Which fraction is equivalent to 3/4?" },
        choices: [
          { id: "a", label: { ar: "٦/٨", en: "6/8" } },
          { id: "b", label: { ar: "٤/٥", en: "4/5" } },
          { id: "c", label: { ar: "٣/٨", en: "3/8" } },
          { id: "d", label: { ar: "٦/٤", en: "6/4" } },
        ],
        correctId: "a",
        hint: { ar: "جرّب أن تضرب البسط والمقام في ٢.", en: "Try multiplying the top and bottom by 2." },
        explanation: { ar: "٣ × ٢ = ٦ و ٤ × ٢ = ٨، إذن ٣/٤ = ٦/٨.", en: "3 × 2 = 6 and 4 × 2 = 8, so 3/4 = 6/8." },
      },
      {
        kind: "fill",
        id: "q2",
        prompt: { ar: "أكمل الكسر المكافئ.", en: "Complete the equivalent fraction." },
        text: { ar: "١/٥ = {{1}}/١٥", en: "1/5 = {{1}}/15" },
        blanks: [{ id: "b1", answers: ["3", "٣"] }],
        explanation: {
          ar: "المقام ضُرب في ٣ (٥ × ٣ = ١٥)، فنضرب البسط في ٣ أيضًا: ١ × ٣ = ٣.",
      ...
      },
      {
        kind: "sort",
        id: "q3",
        prompt: { ar: "صنّف كل كسر: هل يساوي ١/٢ أم ١/٣؟", en: "Sort each fraction: does it equal 1/2 or 1/3?" },
        buckets: [
          { id: "half", label: { ar: "يساوي ١/٢", en: "Equals 1/2" } },
          { id: "third", label: { ar: "يساوي ١/٣", en: "Equals 1/3" } },
        ],
        items: [
          { id: "i1", label: { ar: "٣/٦", en: "3/6" }, bucketId: "half" },
          { id: "i2", label: { ar: "٢/٦", en: "2/6" }, bucketId: "third" },
          { id: "i3", label: { ar: "٥/١٠", en: "5/10" }, bucketId: "half" },
          { id: "i4", label: { ar: "٤/١٢", en: "4/12" }, bucketId: "third" },
        ],
        explanation: {
          ar: "اقسم البسط والمقام على العامل المشترك: ٣/٦ ÷ ٣ = ١/٢، و٤/١٢ ÷ ٤ = ١/٣.",
      ...
      },
      {
        ...
        answer: false,
        explanation: {
          ar: "نقسم، لا نطرح. ٤/٦ ÷ ٢ = ٢/٣ صحيحة، أما ٤−٢ / ٦−٢ = ٢/٤ فهي مقدار مختلف.",
    ...
    blocks: [
      {
        ...
        body: {
          ar: "حكمت أسرة تيودور إنجلترا بين عامي ١٤٨٥ و١٦٠٣، أي نحو ١١٨ عامًا. بدأت بهنري السابع بعد انتصاره في معركة بوسورث، وانتهت بوفاة إليزابيث الأولى. في هذه الفترة تغيّرت ديانة البلاد أكثر من مرة، واتسع أسطولها، وازدهر مسرحها.",
        ...
        visual: {
          ...
          rows: [
            [{ ar: "هنري السابع", en: "Henry VII" }, { ar: "١٤٨٥–١٥٠٩", en: "1485–1509" }, { ar: "إنهاء حرب الوردتين", en: "Ending the Wars of the Roses" }],
            [{ ar: "هنري الثامن", en: "Henry VIII" }, { ar: "١٥٠٩–١٥٤٧", en: "1509–1547" }, { ar: "الانفصال عن روما وزوجاته الست", en: "The break with Rome and his six wives" }],
            [{ ar: "إدوارد السادس", en: "Edward VI" }, { ar: "١٥٤٧–١٥٥٣", en: "1547–1553" }, { ar: "ترسيخ البروتستانتية", en: "Strengthening Protestantism" }],
            [{ ar: "ماري الأولى", en: "Mary I" }, { ar: "١٥٥٣–١٥٥٨", en: "1553–1558" }, { ar: "إعادة الكاثوليكية", en: "Restoring Catholicism" }],
            [{ ar: "إليزابيث الأولى", en: "Elizabeth I" }, { ar: "١٥٥٨–١٦٠٣", en: "1558–1603" }, { ar: "هزيمة الأرمادا وازدهار المسرح", en: "Defeating the Armada and the golden age of theatre" }],
          ],
        },
      },
      {
        ...
        body: {
          ar: "أراد هنري الثامن الطلاق من كاثرين الأراغونية، ورفض البابا. فأعلن هنري نفسه رئيسًا للكنيسة في إنجلترا عام ١٥٣٤، وأغلق الأديرة وصادر أراضيها. لم يكن القرار دينيًا فحسب: فقد أصبح الملك أغنى وأقوى، وفقد كثير من الفقراء ما كانت الأديرة تقدّمه لهم من طعام ورعاية.",
      ...
      },
      {
        ...
        items: [
          { id: "o1", label: { ar: "معركة بوسورث وبداية حكم آل تيودور (١٤٨٥)", en: "The Battle of Bosworth begins Tudor rule (1485)" } },
          { id: "o2", label: { ar: "هنري الثامن يصبح رئيسًا لكنيسة إنجلترا (١٥٣٤)", en: "Henry VIII becomes head of the Church of England (1534)" } },
          { id: "o3", label: { ar: "تولّي إليزابيث الأولى العرش (١٥٥٨)", en: "Elizabeth I comes to the throne (1558)" } },
          { id: "o4", label: { ar: "هزيمة الأرمادا الإسبانية (١٥٨٨)", en: "The defeat of the Spanish Armada (1588)" } },
          { id: "o5", label: { ar: "وفاة إليزابيث ونهاية حكم آل تيودور (١٦٠٣)", en: "Elizabeth dies and Tudor rule ends (1603)" } },
        ],
        explanation: {
      ...
      },
      {
        ...
        title: { ar: "خلاصة الدرس", en: "Lesson summary" },
        points: [
          { ar: "حكم آل تيودور إنجلترا ١٤٨٥–١٦٠٣.", en: "The Tudors ruled England from 1485 to 1603." },
