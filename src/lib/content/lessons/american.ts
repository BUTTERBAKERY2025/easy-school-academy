...
export const americanLessons: LessonLibrary = {
  ...
  "american-g0-math-number-1": {
    ...
    free: true,
    objectives: [
      { ar: "أن يعدّ الطالب الأشياء حتى 10 عدًّا صحيحًا.", en: "Count objects up to 10 accurately." },
    ...
    blocks: [
      {
        ...
        visual: {
          ...
          cols: 5,
          glyph: "🍎",
          caption: { ar: "نعدّ التفاحات: 1، 2، 3، 4، 5. إذن لدينا 5 تفاحات.", en: "Count the apples: 1, 2, 3, 4, 5. So there are 5 apples." },
        },
      },
      {
        kind: "example",
        ...
        steps: [
          ...
          { ar: "آخر عدد قلته هو 6، إذن عدد النجوم 6.", en: "The last number you said was 6, so there are 6 stars." },
        ],
      ...
      },
      {
        ...
        choices: [
          { id: "a", label: { ar: "3", en: "3" } },
          { id: "b", label: { ar: "4", en: "4" } },
          { id: "c", label: { ar: "5", en: "5" } },
        ],
        correctId: "b",
        hint: { ar: "المس كل بالونة وأنت تعدّ.", en: "Touch each balloon as you count." },
        explanation: {
          ar: "نعدّ: 1، 2، 3، 4. آخر عدد قلناه هو 4، إذن عدد البالونات 4.",
      ...
      },
      {
        ...
        items: [
          { id: "n1", label: { ar: "1", en: "1" } },
          { id: "n2", label: { ar: "2", en: "2" } },
          { id: "n3", label: { ar: "3", en: "3" } },
          { id: "n4", label: { ar: "4", en: "4" } },
          { id: "n5", label: { ar: "5", en: "5" } },
        ],
        explanation: {
          ar: "هذا هو ترتيب العدّ الذي نستعمله كل يوم: 1، 2، 3، 4، 5.",
    ...
    blocks: [
      {
        ...
        body: {
          ar: "في الكسر 3/8 المقام هو 8، ويعني أن الكل قُسّم إلى 8 قطع متساوية. والبسط 3 يعني أننا أخذنا 3 من تلك القطع. ما دام المقام واحدًا فالقطع كلها بالحجم نفسه، ولذلك نستطيع جمعها مباشرة.",
        ...
        visual: { type: "fraction", numerator: 3, denominator: 8, caption: { ar: "3 من 8 قطع متساوية", en: "3 of 8 equal pieces" } },
      },
      {
        kind: "callout",
        id: "t1",
      ...
      },
      {
        kind: "example",
        id: "e1",
        title: { ar: "مثال محلول: 2/5 + 1/5", en: "Worked example: 2/5 + 1/5" },
        steps: [
          { ar: "المقامان متساويان (5 و5)، إذن نستطيع الجمع مباشرة.", en: "The denominators match (5 and 5), so we can add straight away." },
          { ar: "نجمع البسطين: 2 + 1 = 3.", en: "Add the numerators: 2 + 1 = 3." },
          { ar: "نترك المقام كما هو: 5.", en: "Keep the denominator: 5." },
          { ar: "الناتج: 3/5.", en: "The answer is 3/5." },
        ],
        visual: { type: "fraction", numerator: 3, denominator: 5, caption: { ar: "2/5 ثم قطعة أخرى = 3/5", en: "2/5 plus one more piece makes 3/5" } },
      },
      {
        kind: "callout",
        id: "w1",
        ...
        body: {
          ar: "لا تجمع المقامات! 2/5 + 1/5 ليست 3/10. لو جمعت المقامات لكنت غيّرت حجم القطعة نفسها أثناء الحل.",
      ...
      },
      {
        kind: "mcq",
        id: "q1",
        prompt: { ar: "ما ناتج 3/7 + 2/7؟", en: "What is 3/7 + 2/7?" },
        choices: [
          { id: "a", label: { ar: "5/14", en: "5/14" } },
          { id: "b", label: { ar: "5/7", en: "5/7" } },
          { id: "c", label: { ar: "6/7", en: "6/7" } },
          { id: "d", label: { ar: "1/7", en: "1/7" } },
        ],
        correctId: "b",
        hint: { ar: "اجمع البسطين فقط.", en: "Add only the numerators." },
        explanation: {
          ar: "3 + 2 = 5 والمقام يبقى 7، إذن الناتج 5/7.",
      ...
      },
      {
        ...
        text: { ar: "9/10 − 4/10 = {{1}}/{{2}}", en: "9/10 − 4/10 = {{1}}/{{2}}" },
        blanks: [
          { id: "b1", answers: ["5"] },
          { id: "b2", answers: ["10"] },
        ],
        explanation: {
          ar: "9 − 4 = 5، والمقام يبقى 10، إذن الناتج 5/10 (ويساوي نصفًا).",
      ...
      },
      {
        ...
        items: [
          { id: "i1", label: { ar: "1/6 + 4/6", en: "1/6 + 4/6" }, bucketId: "direct" },
          { id: "i2", label: { ar: "1/3 + 1/4", en: "1/3 + 1/4" }, bucketId: "convert" },
          { id: "i3", label: { ar: "5/9 − 2/9", en: "5/9 − 2/9" }, bucketId: "direct" },
          { id: "i4", label: { ar: "2/5 + 1/2", en: "2/5 + 1/2" }, bucketId: "convert" },
        ],
        explanation: {
      ...
      },
      {
        ...
        id: "q4",
        prompt: {
          ar: "أكلت سارة 3/8 من البيتزا، وأكل أخوها 2/8 منها. كم أكلا معًا؟",
          en: "Sara ate 3/8 of a pizza and her brother ate 2/8. How much did they eat together?",
        },
        choices: [
          { id: "a", label: { ar: "5/8 من البيتزا", en: "5/8 of the pizza" } },
          { id: "b", label: { ar: "5/16 من البيتزا", en: "5/16 of the pizza" } },
          { id: "c", label: { ar: "1/8 من البيتزا", en: "1/8 of the pizza" } },
        ],
        correctId: "a",
        explanation: {
          ar: "البيتزا نفسها مقسّمة إلى 8 قطع، فنجمع البسطين: 3 + 2 = 5، والناتج 5/8.",
      ...
      },
      {
        kind: "truefalse",
        id: "q5",
        statement: { ar: "4/9 + 5/9 يساوي واحدًا صحيحًا.", en: "4/9 + 5/9 equals one whole." },
        answer: true,
        explanation: {
          ar: "4 + 5 = 9، والناتج 9/9، وأي كسر بسطه يساوي مقامه يساوي واحدًا صحيحًا.",
  ...
  "american-g5-science-life-2": {
    ...
    blocks: [
      ...
      },
      {
        ...
        body: {
          ar: "في كل مستوى تُفقد معظم الطاقة على شكل حرارة وحركة وتنفّس؛ لا ينتقل إلى المستوى التالي إلا نحو 10% منها. لهذا نادرًا ما تجد سلسلة غذائية فيها أكثر من أربعة أو خمسة مستويات: لا تبقى طاقة كافية.",
      ...
      },
      {
        ...
        points: [
          ...
          { ar: "نحو 10% فقط من الطاقة تنتقل بين المستويات.", en: "Only about 10% of energy passes between levels." },
    ...
    blocks: [
      {
        ...
        body: {
          ar: "الميل m يخبرنا كم تتغيّر y مقابل كل زيادة مقدارها 1 في x. نحسبه من نقطتين بالعلاقة m = (y₂ − y₁) ÷ (x₂ − x₁)، أي «التغيّر الرأسي ÷ التغيّر الأفقي». الميل الموجب يعني صعودًا، والسالب هبوطًا، والصفر يعني خطًا أفقيًا.",
      ...
      },
      {
        kind: "example",
        id: "e1",
        title: { ar: "مثال محلول: ميل المستقيم المار بـ (2، 3) و(6، 11)", en: "Worked example: the line through (2, 3) and (6, 11)" },
        steps: [
          { ar: "التغيّر الرأسي = y₂ − y₁ = 11 − 3 = 8.", en: "Rise = y₂ − y₁ = 11 − 3 = 8." },
          { ar: "التغيّر الأفقي = x₂ − x₁ = 6 − 2 = 4.", en: "Run = x₂ − x₁ = 6 − 2 = 4." },
          { ar: "الميل m = 8 ÷ 4 = 2.", en: "Slope m = 8 ÷ 4 = 2." },
          { ar: "نعوّض في y = mx + b باستخدام النقطة (2، 3): 3 = 2(2) + b، إذن b = −1.", en: "Substitute into y = mx + b using (2, 3): 3 = 2(2) + b, so b = −1." },
          { ar: "المعادلة: y = 2x − 1.", en: "The equation is y = 2x − 1." },
        ],
      },
      {
        kind: "callout",
      ...
      },
      {
        kind: "mcq",
        id: "q1",
        prompt: { ar: "ما ميل المستقيم المار بالنقطتين (1، 5) و(4، 14)؟", en: "What is the slope of the line through (1, 5) and (4, 14)?" },
        choices: [
          { id: "a", label: { ar: "3", en: "3" } },
          { id: "b", label: { ar: "9", en: "9" } },
          { id: "c", label: { ar: "1/3", en: "1/3" } },
          { id: "d", label: { ar: "−3", en: "−3" } },
        ],
        correctId: "a",
        hint: { ar: "احسب (14 − 5) ÷ (4 − 1).", en: "Work out (14 − 5) ÷ (4 − 1)." },
        explanation: { ar: "(14 − 5) ÷ (4 − 1) = 9 ÷ 3 = 3.", en: "(14 − 5) ÷ (4 − 1) = 9 ÷ 3 = 3." },
      },
      {
        kind: "concept",
        id: "c2",
        ...
        body: {
          ar: "اشتراك ناد رياضي رسم انضمام 50 ريالًا، ثم 30 ريالًا شهريًا. إذا كانت y هي التكلفة و x عدد الشهور فإن y = 30x + 50. هنا الميل 30 هو التكلفة الشهرية، والمقطع الصادي 50 هو ما تدفعه قبل أن يمر أي شهر.",
        ...
        visual: {
          ...
          rows: [
            [{ ar: "0", en: "0" }, { ar: "50", en: "50" }],
            [{ ar: "1", en: "1" }, { ar: "80", en: "80" }],
            [{ ar: "2", en: "2" }, { ar: "110", en: "110" }],
            [{ ar: "3", en: "3" }, { ar: "140", en: "140" }],
          ],
          caption: { ar: "تزيد التكلفة 30 في كل شهر: هذا هو الميل.", en: "The cost rises by 30 each month: that is the slope." },
        },
      },
      {
        kind: "fill",
        ...
        text: {
          ar: "مستقيم ميله 4 ويقطع المحور الصادي عند −7، معادلته: y = {{1}}x + ({{2}})",
        ...
        explanation: {
          ar: "في الصيغة y = mx + b يكون m الميل و b المقطع الصادي، إذن y = 4x + (−7) = 4x − 7.",
      ...
      },
      {
        ...
        items: [
          { id: "i1", label: { ar: "y = 5x + 1", en: "y = 5x + 1" }, bucketId: "pos" },
          { id: "i2", label: { ar: "y = −2x + 9", en: "y = −2x + 9" }, bucketId: "neg" },
          { id: "i3", label: { ar: "y = 7", en: "y = 7" }, bucketId: "zero" },
          { id: "i4", label: { ar: "y = 0.5x", en: "y = 0.5x" }, bucketId: "pos" },
          { id: "i5", label: { ar: "y = −x − 3", en: "y = −x − 3" }, bucketId: "neg" },
        ],
        explanation: {
      ...
      },
      {
        ...
        id: "q4",
        prompt: {
          ar: "سيارة أجرة تحسب y = 2.5x + 8 حيث x المسافة بالكيلومترات. ماذا يمثّل العدد 8؟",
        ...
        correctId: "b",
        explanation: {
          ar: "عند x = 0 تكون y = 8، أي التكلفة قبل قطع أي مسافة: إنها الأجرة الثابتة، والميل 2.5 هو التكلفة لكل كيلومتر.",
